...
router.get('/:slug', middleware.verify_logout_from_admin, productController.link_to);
router.get('/', middleware.verify_logout_from_admin, productController.getHomePage);
